...
from llama_recipes.model_checkpointing import save_model_and_optimizer_sharded, save_optimizer_checkpoint
...
def save_model_checkpoint(
    ...
    if rank == 0:
        ...
        model.save_pretrained(model_path, state_dict=state_dict)
        print(f"model checkpoint saved for epoch {epoch} at {model_path}\n")
